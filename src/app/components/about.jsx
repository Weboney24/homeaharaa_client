      ...
      <div className="w-full relative">
        <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
          <div className="lg:col-span-5 md:col-span-6">
            <Image src={ImageHelper.ShopGoodsImage} width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} className="rounded-t-full shadow-md dark:shadow-gray-800" alt="" />
          </div>
            ...
            <div className="lg:ms-8">
              ...
              <div className="flex items-center mt-6">
                ...
                <div className="">
                  ...
                  <Link href="#" scroll={false} onClick={() => setModal(true)} className="text-orange-500">
                    View on Google map
                  </Link>
                </div>
              </div>
