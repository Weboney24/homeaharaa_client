        ...
        <div className="container relative">
          <div className="grid grid-cols-1">
            <div className="text-center">
              <h6 className="text-slate-900 dark:text-white font-semibold">
      ...
      <section className="relative table w-full items-center pt-36 pb-52 bg-orange-600 bg-[url('/images/hero/bg-shape.png')] bg-center bg-no-repeat bg-cover">
        <div className="container relative">
          <div className="grid grid-cols-1 text-center mt-10">
            <h3 className="md:text-7xl text-5xl md:leading-normal leading-normal tracking-wide font-bold uppercase text-white">
            ...
            <div className="relative z-2 duration-500 sm:-mt-[200px] -mt-[140px] m-0">
              <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6">
                {salesData.map((item, index) => {
                  return (
                    <div
                      className="relative overflow-hidden rounded-md text-center shadow-md"
                      key={index}
                    >
                      <div className="p-6 bg-orange-500">
                        <span className="bg-white text-orange-500 font-bold px-2.5 py-0.5 rounded-full h-5">
                          {item.tag}
                        </span>
                      ...
                      <div className="p-6 bg-white dark:bg-slate-900">
                        ...
                        <h5 className="text-xl font-semibold uppercase mt-1">
                          {item.code}
                        </h5>
                      </div>
                    </div>
