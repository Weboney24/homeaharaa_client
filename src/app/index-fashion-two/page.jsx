            ...
            {newProduct.slice(0, 8).map((item, index) => {
              return (
                <div className="group" key={index}>
                  <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500 !h-[200px]">
                    <Image
                      src={item.image}
                      className="group-hover:scale-110 duration-500 !w-full !h-[200px]"
                      alt=""
                    />
                  ...
                  <div className="mt-4">
                    <Link
                      ...
                      className="hover:text-orange-500 text-lg font-medium line-clamp-1"
                    >
                      {item.name}
                    </Link>
